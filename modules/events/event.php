...
<div>
    <div id="menu" class="leftdiv">
        <form action="eventList.php" method ="post" >
            ...
            <div><select name="filter_city" class="input" onchange="selectCity(this.value)"><?php
            ...
            <div style="height:100px;overflow:auto;"><?php
                ...
                while ($row1 = mysql_fetch_array($result1)) {
                    echo "<input type='checkbox'  name='filter_category' value='{$row1['event_category']}'>{$row1['event_category']}<br>";
                }
                ?></div>
            ...
            <div style="height:100px;overflow:auto;"><?php
                ...
                while ($row2 = mysql_fetch_array($result2)) {
                    ...
                    while ($row3 = mysql_fetch_array($result3)) {
                        echo "<input type='checkbox' name='filter_ngo' value='{$row3['ngo_id']}'>{$row3['ngo_name']}<br>";
                    }
                }
                ?></div>
