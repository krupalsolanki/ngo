...
class PHPMailer {
   ...
   * @var string
   */
  public $Sender            = 'satyam.mgs@gmail.com';
   ...
   * @var string
   */
  public $ReturnPath        = 'satyam.mgs@gmail.com';
   ...
   * @var string
   */
  public $Username      = 'compassitessolution@gmail.com';

  /**
   * Sets SMTP password.
   * @var string
   */
  public $Password      = 'developer@compass';
